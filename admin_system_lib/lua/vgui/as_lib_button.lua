surface.CreateFont("Button_Font1", {
	font = "comfortaa",
	size = Lib.RespX(30),
	weight = 500,
	antialias = true,
...
surface.CreateFont("Button_Font2", {
	font = "comfortaa",
	size = Lib.RespX(20),
	weight = 500,
	antialias = true,
...
function PANEL:Paint(w, h)
    ...
    if self.fontType == 0 then
        draw.SimpleText(self.text, "Button_Font1", w/2, h/2, self.textColor, 1, 1)
    ...
    elseif self.fontType == 1 then
        ...
        draw.SimpleText(self.text, "Button_Font2", w/2, h/2, self.textColor, 1, 1)
...
derma.DefineControl("AS_DButton", " AS DButton", PANEL, "DButton")