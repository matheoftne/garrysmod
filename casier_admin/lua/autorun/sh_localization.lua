...
AWarn.localizations["EN"] = {
	cl1		=		"", --Found in cl_init.lua
	cl2		=		"Version", --Found in cl_init.lua
	cl3		=		"Right Click on a player for more options!", --Found in cl_init.lua
	cl4		=		"Infractions récentes", --Found in cl_init.lua
	cl5		=		"Infractions totales", --Found in cl_init.lua
	cl6		=		"Recherche par SteamID", --Found in cl_init.lua
	cl7		=		"Administrateur", --Found in cl_init.lua
	cl8		=		"Infraction", --Found in cl_init.lua
	cl9		=		"Serveur", --Found in cl_init.lua
	cl10	=		"Date/Heure", --Found in cl_init.lua
	cl11	=		"Supprimer l'infraction", --Found in cl_init.lua
	cl12	=		"Copier l'infraction", --Found in cl_init.lua
	cl13	=		"L'infraction à bien été copier!", --Found in cl_init.lua
	cl14	=		"Joueurs", --Found in cl_init.lua
	cl15	=		"Nouvelle Entrée", --Found in cl_init.lua
	cl16	=		"Effacer l'infraction", --Found in cl_init.lua
	cl17	=		"Réduire les infractions récentes", --Found in cl_init.lua
	cl18	=		"Voir les infractions !", --Found in cl_init.lua
	cl19	=		"Vos infractions actives: ", --Found in cl_init.lua
	cl20	=		"Vos infractions totales: ", --Found in cl_init.lua
	cl21	=		"AWarn Warning Menu", --Found in cl_init.lua
	cl22	=		"Joueur: ", --Found in cl_init.lua
	cl23	=		"Valider", --Found in cl_init.lua
	cl24	=		"Annuler", --Found in cl_init.lua
	cl25	=		"Options casier administratif", --Found in cl_init.lua
...
AWarn.localizations["FR"] = {
    ...
    sv5     =       "Vous DEVEZ inclure une raison. Désactivez-le dans les options.", --Found in sv_init.lua
    sv6     =       "Vous avez été averti par", --Found in sv_init.lua
    sv7     =       "Tapez !casier pour voir la liste de vos avertissements.", --Found in sv_init.lua/awarn_sql.lua
    sv8     =       "Cette commande ne peut pas être exécuté à partir de la console du serveur!", --Found in sv_init.lua
    sv9     =       "Ce joueur ne peut pas être averti!", --Found in sv_awarn.lua
    sv10    =       "Les joueurs de ce groupe ne peuvent pas être avertis!", --Found in sv_awarn.lua
